...
const mavlink = require('/home/shining17/ardupilot/mavlink1');
...
client.on('message', (msg) => {
    try {
        const parsedMessages = mav.parse_buffer(msg);
        parsedMessages.forEach((parsedMessage) => {
            if (parsedMessage.name === 'GLOBAL_POSITION_INT') {
                currentLat = parsedMessage.lat / 1e7;
                currentLon = parsedMessage.lon / 1e7;
                currentAlt = parsedMessage.relative_alt / 1000;
